...
**已创建群，239615726，欢迎大家加入，一起学习交流！** [点击扫码加群239615726](https://static.oschina.net/uploads/space/2017/0313/112312_AYyi_117082.png)
...
--session.exptime = 1800 --修改seesion失效时间时，默认30分钟
--session.cache = ngx_shared['seesion_cache'] --默认使用ngx的缓存，对应runtime/nginx.conf里的lua_shared_dict配置项
